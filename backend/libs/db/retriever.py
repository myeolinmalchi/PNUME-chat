...
class Retriever:
    def __init__(self):
        ...
        self.repository = NoticeRepository('notice', (1 ,2), dictionary)
...
retriever = Retriever()
prompt = retriever.total_similarity_retrieve(question=question, question_vector=question_vector)
print(prompt)